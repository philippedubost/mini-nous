...
export function getStudioCaps(metadata, workflowStatus, admin = false) {
  ...
  if (admin) {
    return {
      ...
      showVersionPicker: pickRequired && lineartVersion >= 3,
  ...
  return {
    ...
    showVersionPicker: pickRequired && lineartVersion >= 3 && workflowStatus === 'pending_validation',
    revisionPending: workflowStatus === 'revision_requested',
  }
}
