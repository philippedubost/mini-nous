...
function buildConfirmationHtml({
  customerFirstName, customerName, packLabel, faceCount, shipLabel, orderUrl, studioUrl, sourcePhotoUrl,
}) {
...
function buildLineartReadyHtml({
  customerFirstName, customerName, packLabel, faceCount, orderUrl, studioUrl, sourcePhotoUrl, previewUrl, lineartVersion = 1,
}) {
  const greeting = emailGreeting(customerFirstName, customerName)
  return `<!DOCTYPE html>
<html lang="fr">
...
function buildVersionPickHtml({
  customerFirstName, customerName, packLabel, faceCount, orderUrl, studioUrl, versions,
}) {
  const greeting = emailGreeting(customerFirstName, customerName)
