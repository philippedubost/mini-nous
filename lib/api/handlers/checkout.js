...
import { createPendingOrder } from '../../server/orders.js'
import { computeQuote, getPack } from '../../server/packs.js'
...
export default async function handler(req, res) {
  ...
  try {
    const { pack, faceCount, email, customerName, giftDelivery, giftRecipientName, giftMessage, childCount } = req.body ?? {}
