    ...
    if (req.method === 'PATCH') {
      ...
      if (action === 'validate') {
        ...
        await supabase
          ...
          .update({
            ...
            metadata: {
              ...
              selected_lineart_version_id: versionId || meta.selected_lineart_version_id || null,
        ...
        sendDesignValidatedEmailIfNeeded(req, {
          ...
          previewUrl: publicAssetUrl(req, rawPreview),
          sourcePhotoUrl: publicAssetUrl(req, rawPhoto ?? meta.paywall_source_url),
          lineartVersion: validatedStudioVersion,
      ...
      if (action === 'update_composition') {
        ...
        const { generation } = await loadOrderContext(supabase, order)
