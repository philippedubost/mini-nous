...
import { buildWeekBatch, buildGenerationsBatch, fetchWeekOrders, listProductionWeeks } from '../../server/batch.js'
import { getProductionSchedule, getPaidOrderCount, getSoldCharacterCount, formatFabricationMardiLabel } from '../../server/weeks.js'
import {
  assignGenerationToWeek,
  listAvailableGenerationsForWeek,
  removeAdminOrderFromWeek,
} from '../../server/orders.js'
import { buildFabricationPayload, loadWeeksById } from '../../server/fabrication.js'
